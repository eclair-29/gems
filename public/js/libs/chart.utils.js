...
(() => {
    ...
    function Mt(t) {
        ...
        return (
            t.year < 100 &&
                t.year >= 0 &&
                ((e = new Date(e)),
                e.setUTCFullYear(e.getUTCFullYear() - 1900)),
            +e
        );
    }
    function kt(t) {
            ...
            (this.opts = { style: "long", ...n }),
                !e &&
                    ...
                    (this.rtf = (function (t, e = {}) {
                        ...
                        return (
                            i ||
                                ((i = new Intl.RelativeTimeFormat(t, e)),
                                (be[s] = i)),
                            i
                        );
                    })(t, n));
            ...
            const s = t || me.defaultLocale,
                i =
                    ...
                    (r
                        ? "en-US"
                        : ve ||
                          ((ve = new Intl.DateTimeFormat().resolvedOptions()
                              .locale),
                          ve)),
    ...
    function We(t, e, n, r, s, i, a) {
        ...
        return (
            ...
            t &&
                (o.weekday =
                    t.length > 3 ? At.indexOf(t) + 1 : Rt.indexOf(t) + 1),
            o
        );
    }
    const Pe =
    ...
    class vn {
        ...
        set(t) {
            return this.isValid
                ? wn(this, {
                      values: { ...this.values, ...Ct(t, vn.normalizeUnit) },
                  })
                : this;
        }
        reconfigure({
        ...
        shiftTo(...t) {
            ...
            for (const i of gn)
                if (t.indexOf(i) >= 0) {
                    ...
                    let t = 0;
                    for (const e in n)
                        (t += this.matrix[e][i] * n[e]), (n[e] = 0);
                    ct(r[i]) && (t += r[i]);
                    const a = Math.trunc(t);
                    (e[i] = a), (n[i] = (1e3 * t - 1e3 * a) / 1e3);
                    for (const t in r)
                        gn.indexOf(t) > gn.indexOf(i) &&
                            bn(this.matrix, r, t, e, i);
                } else ct(r[i]) && (n[i] = r[i]);
            for (const t in n)
                0 !== n[t] &&
                    (e[s] += t === s ? n[t] : n[t] / this.matrix[s][t]);
    ...
    class Sn {
        ...
        set({ start: t, end: e } = {}) {
            return this.isValid
                ? Sn.fromDateTimes(t || this.s, e || this.e)
                : this;
        }
        splitAt(...t) {
            ...
            for (const t of i)
                (n += "s" === t.type ? 1 : -1),
                    1 === n
                        ...
                        : (e &&
                              +e != +t.time &&
                              r.push(Sn.fromDateTimes(e, t.time)),
                          (e = null));
            return Sn.merge(r);
        }
        difference(...t) {
    ...
    function zn(t, e) {
        return t
            ? Gt.create(e, t)
                  .formatDateTimeParts(
                      (An || (An = Sr.fromMillis(1555555555555)), An)
                  )
                  .map((e) =>
                      (function (t, e, n) {
    ...
    class Sr {
        constructor(t) {
            ...
            if (!n)
                if (t.old && t.old.ts === this.ts && t.old.zone.equals(e))
                    ...
                    (r = ir(this.ts, t)),
                        (n = Number.isNaN(r.year)
                            ? new Xt("invalid input")
                            : null),
                        (r = n ? null : r),
                        (s = n ? null : t);
                }
        ...
        plus(t) {
            return this.isValid
                ? rr(this, or(this, vn.fromDurationLike(t)))
                : this;
        }
        minus(t) {
            return this.isValid
    ...
    const Mr = (() => {
        ...
        class e {
            ...
            months(t) {
                ...
                let i, a;
                for (i = 0; i < n; ++i)
                    (a = this.MONTHS[Math.ceil(i) % 12]),
                        s.push(a.substring(0, r));
                return s;
            }
            color(t) {
